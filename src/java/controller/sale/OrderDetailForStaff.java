 ...
 * @author acer
 */
public class OrderDetailForStaff extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("orderDetials", detailsList);
        request.getRequestDispatcher("view/sale/orderDetailForStaff.jsp").forward(request, response);
    } 
