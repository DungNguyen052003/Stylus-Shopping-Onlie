        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form id="filterForm" action="MktDashboard" method="get">
                        <div class="container"style="max-width: 100%">
                            <h3>Statistics Dashboard</h3><br>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card bg-c-blue order-card">
                                        <div class="card-block">
                                            <a href="/posts">
                                                <h6 class="m-b-20">Posts</h6>
                                                <h2 class="text-right"><i class="fa fa-file-text f-left"></i><span>${postCount}</span></h2>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card bg-c-green order-card">
                                        <div class="card-block">
                                            <a href="/products">
                                                ...
                                                <h2 class="text-right"><i class="fa fa-product-hunt f-left"></i><span>${productCount}</span></h2>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card bg-c-yellow order-card">
                                        <div class="card-block">
                                            <a href="/customers">
                                                ...
                                                <h2 class="text-right"><i class="fa fa-users f-left"></i><span>${customerCount}</span></h2>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card bg-c-pink order-card">
                                        <div class="card-block">
                                            <a href="/feedbacks">
                                                ...
                                                <h2 class="text-right"><i class="fa fa-comments f-left"></i><span>${feedbackCount}</span></h2>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- New Container for Date Filter and Chart inside a Border Box -->
                            <div class="border-box">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">New Customers Trend (Last 7 Days)</h3>

                                    </div>
                                    <div class="box-body"><br>
                                        <form method="get" action="mkt">
                    ...
                    <script>
                        const ctx = document.getElementById('newCustomersTrendChart').getContext('2d');
                        const labelsForNewCustomers = [
                        <c:forEach var="date" items="${last7DaysForNewCustomers}">
                            '${date}',
                        </c:forEach>
                        ];
                        const dataForNewCustomers = [
                        <c:forEach var="date" items="${last7DaysForNewCustomers}">
                            ${newCustomersTrend[date] != null ? newCustomersTrend[date] : 0},
                        </c:forEach>
                        ];
                        const newCustomersTrendChart = new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: labelsForNewCustomers,
                                datasets: [{
                                        label: 'New Customers',
                                        data: dataForNewCustomers,
                                        backgroundColor: '#00a65a',
                                        borderColor: '#00a65a',
                                        borderWidth: 1,
                                        barThickness: 30, // Adjust this value to control the bar width
                                        barPercentage: 0.8, // Adjust this value to control the spacing between bars
                            ...
                            options: {
                                    ...
                                    yAxes: [{
                                            ticks: {
                                                ...
                                                callback: function (value) {
                                                    // Fixed values for the y-axis
                                                    const fixedValues = [1, 5, 10, 15, 50];
                                                    if (fixedValues.includes(value)) {
                                                        return value;
                                                    }
                                                    // Show other values only if they are within the data range
                                ...
                                layout: {
                                    padding: {
                                        left: 20, // Adjust padding to ensure y-axis labels are fully visible
                                        right: 20,
                                        top: 20,
                                        bottom: 20
                                    }
