                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex-shrink-0">
                                                                    <img src="${od.productDetails.product.thumbnail}" alt="" width="55" class="img-fluid">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="flex-lg-grow-1 ms-3">
                                                                    <h5><a class="text-reset">${od.productDetails.product.productName}</a></h5>
                                                                </div>
                                                            </td>
                                                            <td>${od.productDetails.size.name}</td> <!-- Assuming Size is not available, you can change as needed -->
                                                            <td>${od.productDetails.color.name}</td>
                                                            <td>${od.quantity}</td>
                                                            <td class="text-end">$${od.price}</td>
                                                            <td class="text-end">$${od.total}</td>
                                                            <td>${od.order.orderStatus.name}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                                <tfoot>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="card mb-4">
                                        <form method="POST" action="UpdateSale">
                                            <div class="card-body">
                                                <h3 class="h6">Assign to Sale: </h3>
                                                <div class="d-flex align-items-center">
                                                    <input type="hidden" name="orderId" value="${c.order.orderId}">
                                                    <select class="form-control me-3" name="salesperson" aria-label="Order status">
                                                        <c:forEach items="${sales}" var="s">
                                                            <option value="${s.accountID}" ${s.accountID == c.order.account.accountID ? 'selected' : ''}>${s.name} - ${s.totalOrder}</option>
                                                        </c:forEach>
                                                    </select>
                                    ...
                                    <div class="card mb-4">
                                        <form method="POST" action="UpdateSaleNoteForAdmin">
                                            <div class="card-body">
