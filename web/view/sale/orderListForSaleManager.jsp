    ...
    <head>
        ...
        <style>
            ...
            table.table th:nth-child(2), table.table td:nth-child(2) {
                width: 100px; /* Adjust as necessary to make the Customer Name column wider */
            }
            table.table th:nth-child(4), table.table td:nth-child(4) {
                width: 250px; /* Adjust as necessary to make the Product column smaller */
            }
            table.table th:nth-child(7), table.table td:nth-child(7) {
                width: 120px; /* Adjust as necessary to make the Sale Name column wider */
            }
            table.table th:nth-child(6), table.table td:nth-child(7) {
                width: 40px; /* Adjust as necessary to make the Sale Name column wider */
            }
            table.table th:nth-child(5), table.table td:nth-child(7) {
                width: 40px; /* Adjust as necessary to make the Sale Name column wider */
            }
        </style>
    </head>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="filter-group">
                                                    <form action="OrderListOfSaleAdmin" method="get">
                                                         <input type="hidden" name="action" value="filter"/>
                                                        <label>Sale Name</label>
                                                        <select class="form-control" name="saleName">
                                                           
                                                            <option value="all">All</option>
                                                            <c:forEach items="${sales}" var="s">
                                                                <option value="${s.accountID}">${s.name}</option>
                                                            </c:forEach>
                                                        </select>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${saleOrder}" var="c">
                                                <tr>
                                                    <td>
                                                        <a href="OrderDetailsForSaleManager?id=${c.orderId}">${c.orderId}</a>
                                                    </td>
                                                    ...
                                                    <td><a href="OrderDetailsForSaleManager?id=${c.orderId}">View</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="clearfix">
                                        <ul class="pagination">
                                            <c:choose>
                                                <c:when test="${page > 1}">
                                                    <li class="page-item">
                                                        <a class="page-link" href="<c:url value='OrderListOfSaleAdmin'>
                                                               ...
                                                               <c:if test='${param.saleName != null}'><c:param name='saleName' value='${param.saleName}'/></c:if>
                                                           </c:url>">Previous</a>   
                                                    </li>
                                                </c:when>
                                                <c:otherwise>
