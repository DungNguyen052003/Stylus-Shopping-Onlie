    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="AddCustomer" class="btn btn-outline-primary btn-sm btn-add-product">
                                                ...
                                                <table class="table table-bordered" style="width: 100%">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listCustomer}" var="l">
                                                            <tr>
                                                                <td class="align-middle" name="id">${l.customerID}</td>
                                                                <td class="align-middle text-center" style="max-width: 150px" name="image">
                                                                    <div class="bg-light d-inline-flex justify-content-center align-items-center align-top">
                                                                        <img class="thumbnail-img" id="${l.customerID}" style="max-width: 100%; max-height: 100%;" src="${l.image}">
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td class="align-middle" name="address">${l.address}</td>
                                                        ...
                                                        <td class="align-middle" name="role">
                                                            <c:forEach var="role" items="${listRole}">
                                                                <c:if test="${l.roleID == role.roleID}">
                                                                    ${role.name}
                                                                </c:if>
                                                            </c:forEach>
                                                        </td>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <div class="btn-group align-top">
                                                                <a href="ViewCustomer?customerID=${l.customerID}" class="btn btn-sm btn-outline-secondary badge">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-container">
                                                            ...
                                                            <!-- Sort Section -->
                                                            <form id="sortForm" action="CustomerList" method="GET">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="sortSelect" class="form-control" name="sort" onchange="document.getElementById('sortForm').submit();">
                                                                        ...
                                                                        <option value="id" <%= "id".equals(request.getParameter("sort")) ? "selected" : "" %>>Sort by Customer ID</option>
        ...
        <script>
            function toggleStatus(icon) {
                ...
                $.ajax({
                    url: 'CustomerList', // URL để xử lý yêu cầu cập nhật
                    type: 'POST',
                    data: {action: 'statusCustomer', id: customerID, status: newStatus},
