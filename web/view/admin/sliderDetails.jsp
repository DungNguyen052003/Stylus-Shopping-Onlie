                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrumb__links">
                                ...
                                <a href="ManageSliders">Manage Slider</a>
            ...
            <div class="container py-5">
                    ...
                    <div class="col-lg-6">
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                ...
                                <img class="product__big__img" src="${slider.image}" alt="Product Image" style="width: 100%; height: auto; object-fit: cover;">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="product-details">
                        <h4 class="fw-bold mb-3">Campaign: ${slider.title}</h4>
                        <p class="mb-3" style="font-size: 18px; color: #666;">Category: ${slider.categoryId.name}</p>
                        <p class="mb-3" style="font-size: 18px; color: #666;">Note: ${slider.note}</p>
                        <p class="mb-3" style="font-size: 18px; color: #666;">Backlink: <a href="${slider.backlink}" target="_blank">${slider.backlink}</a></p>
                        <div class="status-container mb-3">
                            ...
                            <i id="statusToggle" class="fa cursor-pointer
                               <c:choose>
                                   <c:when test="${slider.status eq 1}">fa-toggle-on text-secondary</c:when>
