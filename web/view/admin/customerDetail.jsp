...
<html>
    ...
    <style type="text/css">
        ...
        .border-box {
            ...
            border-radius: 8px;
            margin: 0 15px; /* Adjust the margins as needed */
        }
        ...
        .inner-border-box {
            ...
            border-radius: 8px;
            margin-bottom: 20px; /* Add some space between the inner boxes */
        }
        ...
        .e-table .table th, .e-table .table td {
            border-right: 1px solid #ddd; /* Add vertical borders to the table cells */
            padding: 15px;
        ...
        .e-table .table th {
            ...
            color: #333;
            font-weight: bold;
            border-right: 1px solid #ddd; /* Add vertical borders to the table header */
            border-bottom: none; /* Remove bottom border from table header */
        }

        .e-table .table td {
            border-bottom: 1px solid #ddd; /* Add bottom border to table body cells */
        }

        .e-table .table th:last-child, .e-table .table td:last-child {
        ...
        .table-email, .table-address, .table-fullname {
            width: 20%; /* Adjust the widths for larger columns */
        }

        .table-gender, .table-mobile, .table-updatedby, .table-updateddate {
            width: 10%; /* Adjust the widths for smaller columns */
        }
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <!--                        <li class="treeview">
                                                <a href="#">/-strong/-heart:>:o:-((:-h<i class="fa fa-pie-chart"></i>
                                                    <span>Charts</span>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 text-right">
                                                        <button type="submit" form="customerForm" class="btn btn-primary">
                                                            <a class="material-icons">&#xE161;</a> <span>Save</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <form id="customerForm" action="CustomerDetail" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <input type="text" class="form-control" name="status" value="${customer.status}" readonly>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="e-panel card">
                                        <div class="card-body">
                                            <div class="card-title">
                                                <h2 class="mr-2"><span>Change History</span></h2>
                                            </div>
                                            <div class="e-table">
                                                <div class="table-responsive table-lg mt-3" style="max-height: 300px; overflow-y: auto;">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th class="table-email">Email</th>
                                                                <th class="table-fullname">Full Name</th>
                                                                <th class="table-gender">Gender</th>
                                                                <th class="table-mobile">Mobile</th>
                                                                <th class="table-address">Address</th>
                                                                <th class="table-updatedby">Updated By</th>
                                                                <th class="table-updateddate">Updated Date</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach var="history" items="${changeHistory}">
                                                                <tr>
                                                                    <td class="table-email">${history.email}</td>
                                                                    <td class="table-fullname">${history.name}</td>
                                                                    ...
                                                                    <td class="table-mobile">${history.phone}</td>
                                                                    <td class="table-address">${history.address}</td>
                                                                    <td class="table-updatedby">${history.updatedBy}</td>
                                                                    <td class="table-updateddate">${history.updatedDate}</td>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
                                                    </table>
