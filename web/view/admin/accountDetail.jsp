                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="${account.image}" class="user-image" alt="User Image">
                                        ...
                                        <div class="account-settings">
                                            <div class="user-profile">
                                                <div class="user-avatar">
                                                    <img src="${account.image}" alt="${account.name}" style="width: 100%; height: auto">
                                                </div>
                                        ...
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="fullName" value="${account.name}">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${account.gender == 2}"><input type="text" class="form-control" id="website" value="Women"></c:when>
                                                        <c:when test="${account.gender == 1}"><input type="text" class="form-control" id="website" value="Men"></c:when>
                                                        <c:when test="${account.gender == 0}"><input type="text" class="form-control" id="website" value="Other"></c:when>
                                                    </c:choose>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" class="form-control" id="role" value="${account.role.name}">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${account.status == 1}">
                                                            <input type="text" class="form-control" id="website" value="Active">
                                                        </c:when>
                                                        <c:otherwise>
                                                            <input type="text" class="form-control" id="website" value="Inactive">
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </div>
