                                        ...
                                        <div class="account-settings">
                                            <div class="user-profile">
                                                <div class="user-avatar">
                                                    <img src="${customer.image}" alt="${customer.name}" style="width: 100%; height: auto">
                                                </div>
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" value="${customer.address}">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${customer.gender == 1}">
                                                            <input type="text" class="form-control" id="website" value="Women">
                                                        </c:when>
                                                        <c:otherwise>
                                                            <input type="text" class="form-control" id="website" value="Men">
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <h6 class="mt-3 mb-2 text-primary">Customer</h6>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <c:set var="roleName" value="" />
                                                <c:forEach var="role" items="${listRole}">
                                                    <c:if test="${customer.roleID == role.roleID}">
                                                        <c:set var="roleName" value="${role.name}" />
                                                    </c:if>
                                                </c:forEach>
                                                <div class="form-group">
                                                    <label for="role">Role</label>
                                                    <input type="text" class="form-control" id="role" value="${roleName}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
